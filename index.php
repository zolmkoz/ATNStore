...
<body >
 ...
 <div class="navbar navbar-inverse navbar-fixed-top " id="menu">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img class="logo-custom" src="assets/img/logotop.gif" alt=""  /></a>
            </div>
 ...
 <div class="container">
               ...
               <div class="col-lg-12  col-md-12 col-sm-12">
                ...
                <div class="flexslider set-flexi" id="main-section" >
                    <ul class="slides move-me">
                        <!-- Slider 01 -->
                        <li>
                              <h3>High Quality ATN Store Products</h3>
    ...
    <div  class="tag-line" >
        ...
        <h2 data-scroll-reveal="enter from the bottom after 0.1s" ><i class="fa fa-circle-o-notch"></i> WELCOME TO THE ATN Store <i class="fa fa-circle-o-notch"></i> </h2>
                   </div>
               </div>
             </div>
         ...
         <div id="testimonials-sec" class="container set-pad" >
           ...
           <div class="row" >
                 ...
                 <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                     <div class="about-div">
                  <center>  <img class="img img-circle" src="assets/img/batman.jpg" style="width:100px;height:100px;" />
                    <h3 >Bruce <br /> Wayne</h3>
                 <hr />
                       <hr />
                   <p >
                   This company is one of the best in the market, they give us what we need on our ATN Store club. Five stars for quality.
                   </p>
				   </center>
               <a class="btn btn-info btn-set"  > PGA Championship 2016</a>
                </div>
                   </div>
				   ...
				   <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                     <div class="about-div">
                  <center>  <img class="img img-circle" src="assets/img/bl.jpg" style="width:100px;height:100px;" />
                   <h3 >Black <br /> Windows</h3>
                 <hr />
                       <hr />
                   <p >
				   ...
				   <br />
               <a class="btn btn-info btn-set"  >7 Majors titles, 4 Masters titles</a>
                </div>
                   </div>
				    ...
				    <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                     <div class="about-div">
                  <center>  <img class="img img-circle" src="assets/img/spiderman.jpg" style="width:100px;height:100px;" />
                   <h3 >Tom <br /> Holland</h3>
                 <hr />
                       <hr />
                   <p >
                   They are so flexible, accessible and they are able to adjust to my schedule which they value trust.
                   </p>
				   </center>
               <a class="btn btn-info btn-set"  >3 Open Championships</a>
                </div>
                   </div>
                 
				 <div class="col-lg-3  col-md-3 col-sm-3" data-scroll-reveal="enter from the bottom after 0.4s">
                     <div class="about-div">
                  <center>  <img class="img img-circle" src="assets/img/ps4.jpg" style="width:100px;height:100px;" />
                   <h3 >Tony<br />Stark</h3>
                 <hr />
                       <hr />
				   ...
				   <br />
				   <br />
               <a class="btn btn-info btn-set"  >PGA Championship 2007</a>
                </div>
                   </div>
   ...
   <!-- FEATURES SECTION END-->
    ...
    <div class="container set-pad">
             <div class="row text-center">
                 <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                     <h1 data-scroll-reveal="enter from the bottom after 0.1s" class="header-line">Achievements</h1>
                     <p data-scroll-reveal="enter from the bottom after 0.3s">
           ...
           <div class="row" >
                 ...
                 <div class="col-lg-6  col-md-6 col-sm-6" data-scroll-reveal="enter from the bottom after 0.4s">
                     ...
                     <img src="assets/img/top50vn.jpg"  class="img-rounded" style="width:230px;height:200px;"/>
                   <h3 >Top 50 most effective business companies in Vietnam</h3>
                 <hr />
                         <h4>2018<br />Vietnam</h4>
                   <p >
                   In 2018, we (ATN Store) were voted by Forbes Vietnam as one of the Top 50 Most Effective Companies in Vietnam. 
                   We are very honored to have received this brand name. We will not stop trying to add more.
                 ...
                 <div class="col-lg-6  col-md-6 col-sm-6" data-scroll-reveal="enter from the bottom after 0.5s">
                     <div class="faculty-div">
                       <img src="assets/img/sponsor_platium.jpg"  class="img-rounded" style="width:230px;height:200px;"/>
                   <h3 >Platinum Sponsor for the PGA Championship 2019</h3>
                 <hr />
...
<div class="container">
           <div class="row" >
                    ...
                    <img class="img img-rounded img-responsive" src="assets/img/brand.png"  style="width:2000px;height:500px;"/>
...
<br />
    ...
    <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 " data-scroll-reveal="enter from the bottom after 0.4s">
        ...
        <hr />
                    <div>
                        <h4>Corporation ATN Store</H4>
                        <h4> No. 180, 30/4 Street, An Phu Ward</h4>
                        <h4>Ninh Kieu District, Can Tho City.</h4>
						<h4>90000</h4>
        ...
        <hr />
                    <div >
                        <h4><strong>Call:</strong>  +84 143651236 </h4>
                        <h4><strong>Email: </strong>admin@marvel.com</h4>
                    </div>
                    </div>
...
<!-- Script -->
     <!-- CONTACT SECTION END-->
    <div id="footer">
          &copy 2021 ATN Store | All Rights Reserved |  <a style="color: #fff" target="_blank">Design by : zolmkoz</a>
    </div>
     <!-- FOOTER SECTION END-->
